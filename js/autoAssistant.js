...
function onclickArticle(e) {
    ...
    /*if (table.id == 'sNumbTab') {
        var headtext = tr.querySelector('.c2').textContent + ' ' + tr.querySelector('.c3').textContent;
        var headimage = tr.querySelector('img');
        headimage = headimage ? headimage.src : '';
    } else if (table.id == 'sAutoProdTab') {
        headtext = tr.querySelector('.tp2').textContent + ' ' + document.getElementById('tpDescription').textContent;
        headimage = tr.querySelector('img');
        headimage = headimage ? headimage.src : '';
    } else {
        var aCardParent= tr.closest('.aCard');
        headtext = aCardParent ?  tr.querySelector('.tp2').textContent + aCardParent.querySelector('.headCard span').textContent : 'Карточка запчасти';
        headimage = tr.querySelector('img');
        headimage = headimage ? headimage.src : '';
    }*/
    var aCardHead = aCard.querySelector('header');
    /*if (headimage) aCardHead.querySelector('img').src=headimage;
    aCardHead.querySelector('span').textContent = headtext;*/
...
function initialValues() {
    ...
    document.querySelector("#sAutoAuto>button").onclick = function () {
